        ...
        <section class="p-2 lead" style="margin: auto auto !important;width: 50rem;">
            ...
            <form action="<?= BASE_PATH . '/editPassword/editPasswordAction'; ?>" method="POST">
                <div class="input">
                    ...
                    <input class="w-full glass text-gray-less" type="password" name="passwordverif" id="passwordverif" aria-label="Confirmez votre mot de passe" placeholder="Confirmez votre mot de passe" required/>
                </div>
