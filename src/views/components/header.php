...
<header id="layout">
    <a class="flex items-center horizontal text-indigo-4 brand" href="<?= BASE_PATH; ?>">
        ...
        <div class="text-white font-hero flex m" style="margin-left: 1rem">
            ...
            <div class="horizontal">
                ...
                <span><?= $params['user']->getPoints(); ?></span>
            </div>
        </div>
        <?php endif; ?> 
    <nav>
...
<?php if (isset($params['alert'])) : ?>
    <div id="alert" class="w-1/2 lead fade-in glass <?= $params['alert']['type'] ?? 'yellow'; ?> text-gray-less" style="margin: 2rem auto !important;">
