...
<section class="dashboard-content">
    ...
    <form action="<?= BASE_PATH . '/dashboard/edit-campaign'; ?>" method="POST">
        <div class="input-group horizontal">
            ...
            <input type="datetime-local" class="text-white" min="<?= date('Y-m-d');?>T00:00" aria-label="Date et heure de départ" placeholder="Commence le:">
