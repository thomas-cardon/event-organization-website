...
$sql_data = [
    ...
    "INSERT INTO `users` (`id`, `first_name`, `last_name`, `hash`, `email`, `role`, `created_at`, `updated_at`) VALUES
        ...
        (8, 'Gérard', 'Manvussa', '$2y$10\$ecbqAqsHQZ.xXVzCN93P5ucVv7J4vUlNDeCZ315HsxLzPdaYwXsMC', 'Gerard.Manvussa@test.fr', 'donor', '2021-12-29 12:08:25', '2021-12-29 12:08:54'),
        ...
        (10, 'Anne', 'Halle', '$2y$10\$ecbqAqsHQZ.xXVzCN93P5ucVv7J4vUlNDeCZ315HsxLzPdaYwXsMC', 'Anne.Halle@test.fr', 'donor', '2021-12-29 12:08:25', '2021-12-29 12:08:54'),
